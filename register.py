...
class MyRegister(object):
    ...
    def register(name, func):
        ...
        assert name not in MyRegister._REGISTERED, "Dataset{} is already registered".format(name)
    ...
    def get(name,**kwargs):
        ...
        try:
            ...
            raise KeyError("Dataset:'{} is registered Available dataset are:{}".format(name,",".join(MyRegister._REGISTERED.keys())) )
        return f(**kwargs)
